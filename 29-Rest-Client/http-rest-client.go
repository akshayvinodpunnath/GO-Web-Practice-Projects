...
const WEB_SERVICE_HOST string = "http://localhost:8090"
...
func getEmployees(w http.ResponseWriter, r *http.Request) {
	client := resty.New()
	response, err := client.R().Get(WEB_SERVICE_HOST + "/employees")
	//response, err := resty.New().R().Get(WEB_SERVICE_HOST + "/employees")
	if err != nil {
